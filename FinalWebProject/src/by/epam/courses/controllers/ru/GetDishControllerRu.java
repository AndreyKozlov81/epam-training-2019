...
@WebServlet("/GetDishControllerRu")
public class GetDishControllerRu extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(GetDishControllerRu.class);
       
    public GetDishControllerRu() {
        super();
    }
